...
<tileset version="1.2" tiledversion="1.3.4" name="reach_tutorial" tilewidth="64" tileheight="64" tilecount="16" columns="16">
 <image source="../sprites/tutorial/reach_tutorial.png" width="1024" height="64"/>
 <tile id="0">
  <animation>
